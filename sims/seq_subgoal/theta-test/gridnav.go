...
func (ss *Sim) ConfigNet(net *deep.Network) {
	...
	in2, in2p := net.AddInputPulv2D("Input2",worldheight, worldwidth)
	...
	net.ConnectLayers(prvact,in2p, prjn.NewFull(), emer.Forward)
	net.ConnectLayers(prvact,in2, prjn.NewFull(), emer.Forward)

	pj := net.ConnectLayers(in,in2, prjn.NewOneToOne(), deep.BurstTRC)
	pj.SetClass("Strong")
	pj = net.ConnectLayers(in,in2p, prjn.NewOneToOne(), deep.BurstTRC)
	pj.SetClass("Strong")
