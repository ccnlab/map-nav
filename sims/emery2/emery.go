...
func (ss *Sim) ConfigNet(net *deep.Network) {
	...
	cipl, ciplct := deep.AddDeepNoTRC2D(net.AsAxon(), "cIPL", 8, 8)
	...
	pcc, pccct := deep.AddDeepNoTRC2D(net.AsAxon(), "PCC", 8, 8)
	...
	// MStd <-> CIPl
	net.ConnectLayers(mstd, cipl, full, emer.Forward).SetClass("SuperFwd")
	net.ConnectLayers(cipl, mstd, full, emer.Back)

	// CIPl <-> PCC
	net.ConnectLayers(cipl, pcc, full, emer.Forward).SetClass("SuperFwd")
	net.ConnectLayers(pcc, cipl, full, emer.Back)

	// PCC <-> SMA
	net.ConnectLayers(pcc, sma, full, emer.Forward).SetClass("SuperFwd")
	net.ConnectLayers(sma, pcc, full, emer.Back)

	// SMA <-> M1
	net.ConnectLayers(sma, m1, full, emer.Forward).SetClass("SuperFwd")
...
func (ss *Sim) ConfigTrnEpcPlot(plt *eplot.Plot2D, dt *etable.Table) *eplot.Plot2D {
	...
	plt.SetColParams("ActMatch", eplot.On, eplot.FixMin, 0, eplot.FixMax, 1)
